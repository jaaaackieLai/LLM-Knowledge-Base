...
description: Use when the user asks to evaluate whether the LLM Knowledge Base wiki contains enough information to answer source-grounded questions, run a post-compile coverage check, identify answerability gaps from wiki pages only, self-heal high-confidence omissions, and validate repairs with regression plus holdout questions.
---
