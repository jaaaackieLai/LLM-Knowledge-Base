---
name: lint
description: Use when the user asks to lint, audit, or health-check the LLM Knowledge Base wiki for orphan pages, broken links, missing frontmatter, entrance integrity, stale claims, contradictions, or related structural issues.
---
...
Use the user's request text to determine which checks to run.
...
- Compare entrance pages and actual files for inconsistencies
