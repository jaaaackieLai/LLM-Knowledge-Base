---
name: lint
description: Use when the user asks to lint, audit, or health-check the LLM Knowledge Base wiki for orphan pages, broken links, missing frontmatter, index integrity, stale claims, contradictions, or related structural issues.
---
